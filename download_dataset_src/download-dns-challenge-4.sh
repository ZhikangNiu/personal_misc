...
OUTPUT_PATH="/home/v-zhikangniu/wus2_modelblob/users/v-zhikangniu/datas/dns-challenge-4"
...
#     # Same you can download with aria2 
#     aria2c -s16 -x16 "$URL" -d "$OUTPUT_PATH"
#     # tar -C "$OUTPUT_PATH" -f - -x -j
# done

cd "$OUTPUT_PATH"

for file in datasets_fullband.*.tar.bz2; do  
